...
const PrivacyPolicyModule = ({ props }) => {
    ...
    return (
        <section className="PrivacyPolicy">
            <HeadingModule name={'Privacy Policy'} />
            <div className="zl_SecureBackup_heading">

                <h3>Privacy Policy and GDPR Policy</h3>
                <p class="ptext">At Qredit and Altfenix, accessible from https://qredit.io and https://altfenix.com , one of our main
                    priorities is the privacy of our visitors. This Privacy Policy document contains types of information
                    that is collected and recorded by Qredit and how we use it.
                    ...
                    regards to the information that they shared and/or collected in Qredit. This policy is not applicable
                    to any information collected offline or via channels other than this website.</p>

                <h3>Consent</h3>
                <p class="ptext">By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>

                <h3>Information we collect</h3>
                <p class="ptext"> The personal information that you are asked to provide, and the reasons why you are asked to
                ...
                <p class="ptext">We use the information we collect in various ways, including to:
                ...
                <h3>Log Files</h3>
                <p class="ptext">Qredit follows a standard procedure of using log files. These files log visitors when they visit
                ...
                <p class="ptext">Like any other website, Qredit uses 'cookies'. These cookies are used to store information
                ...
                <p class="ptext">You may consult this list to find the Privacy Policy for each of the advertising partners of Qredit.
                    Third-party ad servers or ad networks use technologies like cookies, JavaScript, or Web
                    Beacons that are used in their respective advertisements and links that appear on Qredit, which
                    are sent directly to users' browsers. They automatically receive your IP address when this
                    ...
                    Note that Qredit has no access to or control over these cookies that are used by third-party
                    advertisers.</p>

                <h3>Third Party Privacy Policies</h3>
                <p class="ptext">Qredit's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
                ...
                <p class="ptext">Under the CCPA, among other rights, California consumers have the right to:
                ...
                <p class="ptext">We would like to make sure you are fully aware of all of your data protection rights. Every user is
                ...
                <p class="ptext">Another part of our priority is adding protection for children while using the internet. We
                    encourage parents and guardians to observe, participate in, and/or monitor and guide their online
                    activity.
                    Qredit does not knowingly collect any Personal Identifiable Information from children under the
...
export default connect(null, null)(PrivacyPolicyModule);